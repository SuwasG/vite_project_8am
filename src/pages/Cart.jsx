...
const removeCartHandler=id=>{
   ...
   const confirmed = window.confirm(`Are you sure you want to remove ${itemToRemove ? itemToRemove.title : 'the item'} from the cart?`);
        ...
        <div className="row d-flex justify-content-between my-4">
          ...
          {items && items.length === 0 ? (
           ...
           <div className="col-3">
            ...
            <Link to='/products' className='btn btn-primary rounded-3'>Shop Here</Link>
           </div>
            </div>
